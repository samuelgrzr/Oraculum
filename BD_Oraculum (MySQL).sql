DROP DATABASE Oraculum;
CREATE DATABASE IF NOT EXISTS Oraculum;
USE Oraculum;
...
('Admin', 'admin@oraculum.com', 'admin123', 'admin'),
('Usuario', 'user@oraculum.com', 'user123', 'user');
...
INSERT INTO pregunta (enunciado, dificultad, pista, explicacion, categoria_id) VALUES
